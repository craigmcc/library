        ...
        <Container fluid id="VolumeOptions">
            ...
            <Row className="mb-3">
                ...
                <Col className="text-center">
                    <span>Manage Volume for {props.parent._model}:&nbsp;</span>
                    ...
                    <tr className="table-dark">
                        {(searchText.length > 0) ? (
                            <th
                                ...
                                colSpan={99}
                            >
                                {`Volume for ${libraryContext.library._model}: ${libraryContext.library._title}`}
                            </th>
                        ) : (
                            <th
                                className="text-center"
                                colSpan={99}
                            >
                                {`Volume for ${props.parent._model}: ${props.parent._title}`}
                            </th>
                        )}
