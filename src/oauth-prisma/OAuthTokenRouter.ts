// oauth-prisma/OAuthTokenRouter.ts

/**
 * Express routes for acquiring and revoking tokens.
 *
...
/**
 * Revoke the access token (and any related refresh token) that was used
...
/**
 * Request an access token and optional refresh token.
 */
