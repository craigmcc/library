...
abstract class Fetcher {
     ...
     *
     * @param baseURL       Absolute or relative base URL for fetch requests
     */
     ...
     * and return the result data from the HTTP response.  The
     * build in Fetch API will be utilized.
     *
